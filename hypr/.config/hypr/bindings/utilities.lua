-- Copied verbatim from /usr/share/omarchy/default/hypr/bindings/utilities.lua @ Omarchy 4.0.0.
...
--
-- Personal overrides live in later-loaded modules:
--   hypr/bindings/tiling.lua       unbinds SUPER+K, SUPER+ESCAPE, SUPER+CTRL+code:10..18
--   hypr/bindings/applications.lua unbinds SUPER+CTRL+N, SUPER+CTRL+P
--   hypr/bindings/capture.lua      unbinds PRINT, SUPER+PRINT (drops Color picker)
